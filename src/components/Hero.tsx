...
function HeroContent({ contentOpacity, contentY }: { contentOpacity: number; contentY: number }) {
  return (
    <div style={{ opacity: contentOpacity, transform: `translateY(${contentY}px)` }} className="max-w-xl">
      <h1 className="font-display text-[2.6rem] leading-[1.08] font-extrabold tracking-tight text-cream uppercase sm:text-6xl lg:text-[3.4rem]">
        General dentistry in Houston, TX
      </h1>
      <p className="mt-6 max-w-lg text-lg leading-relaxed text-cream/75">
        Comprehensive dental care for you and your family, from routine checkups to restorative and
        cosmetic treatments.
      </p>
